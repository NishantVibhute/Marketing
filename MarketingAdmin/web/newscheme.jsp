...
<div class="col-sm-9">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea id="editor1" name="schemeDescription" rows="5" cols="105"></textarea>
                  </div>
                </div>
                   <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="" class="form-control" id="inputPassword3"  name="amount" placeholder="0.0">
                  </div>
                </div>
                   <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="" class="form-control" id="inputPassword3"   name="memberPerc" placeholder="0.0">
                  </div>
                </div>
                   <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Company Perc</label>

                  <div class="col-sm-9">
                    <input type="" class="form-control" id="inputPassword3" name="companyPerc" placeholder="0.0">
                  </div>
                </div>
