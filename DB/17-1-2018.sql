...
(1,1,4,2,1,2,'2018-01-17','2018-01-17 20:21:18',400),
(2,1,1,2,1,1,'2018-01-17','2018-01-17 20:21:47',0);
...
insert  into `payment_details`(`id`,`joining_id`,`payment_type`,`cheque_no`,`amount`,`cheque_date`,`bank_name`,`utr_no`,`payment_status`) values 
(1,2,1,'',1000,'','','',2);
...
(1,'Scheme1','DEs','2018-01-10',1,40,60,'2018-01-17 20:21:18',1000,0,1000);
...
(1,'Test1FirstName','Tes1MIddleName','Test1LastName','abc@gmail.com','9869849703','Test1Address','AKDPV2316F','0880-8089-9859-8878','Maharastra bank','7874587545','MUMBAI','457896554',1,0);
...
insert  into `virtualuser`(`id`,`createdate`,`scheme_id`,`balance`) values 
(1,'2018-01-17',1,400);
...
BEGIN
	...
	select jd.id,concat(ud.`first_name`,' ',ud.`middle_name`,' ',ud.`last_name`),jd.`member_type`
...
set isExit =0;		
	...
	SELECT isExit,userId,membertype,Row_count(),schemeid,payModeId;
