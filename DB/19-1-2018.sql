...
insert  into `joining_details`(`id`,`user_id`,`payment_mode_id`,`user_status`,`scheme_id`,`member_type`,`join_date`,`request_date`,`balance`) values 
(1,1,4,2,1,2,'2018-01-19','2018-01-19 17:07:18',1800),
(2,1,1,2,1,1,'2018-01-19','2018-01-19 17:08:45',1800),
(3,2,2,2,1,1,'2018-01-19','2018-01-19 17:09:11',600),
(4,3,3,2,1,1,'2018-01-19','2018-01-19 17:09:22',0),
(5,1,5,2,1,2,'2018-01-19','2018-01-19 17:13:24',0),
(6,2,4,2,1,2,'2018-01-19','2018-01-19 17:15:26',0),
(7,4,1,2,1,1,'2018-01-19','2018-01-19 17:16:54',0),
(8,1,5,2,1,1,'2018-01-19','2018-01-19 17:17:17',0);
...
insert  into `payment_details`(`id`,`joining_id`,`payment_type`,`cheque_no`,`amount`,`cheque_date`,`bank_name`,`utr_no`,`payment_status`,`payment_date`) values 
(1,2,1,'',1000,'','','',2,'2018-01-19 17:08:45'),
(2,3,2,'5447784',1000,'30/01/2018','Mumbai','',2,'2018-01-19 17:09:11'),
(3,4,3,'',1000,'','','9854785',2,'2018-01-19 17:09:22'),
(4,5,4,NULL,1000,NULL,NULL,NULL,2,'2018-01-19 17:13:24'),
(5,6,4,NULL,1000,NULL,NULL,NULL,2,'2018-01-19 17:15:26'),
(6,7,1,'',1000,'','','',2,'2018-01-19 17:16:54'),
(7,8,5,'',1000,'','','',2,'2018-01-19 17:17:17');
...
insert  into `scheme_1`(`id`,`parent_join_id`,`child1_join_id`,`child2_join_id`,`child3_join_id`,`join_count`) values 
(1,1,2,3,4,3),
(2,2,5,6,7,3),
(3,3,8,NULL,NULL,1),
...
insert  into `scheme_details`(`id`,`scheme_name`,`scheme_description`,`scheme_start_date`,`is_scheme_active`,`member_perc`,`company_perc`,`inserted_date_time`,`amount`,`is_closed`,`balance`) values 
(1,'Scheme1','THIS is new Scheme','2018-01-20',1,60,40,'2018-01-19 17:07:18',1000,0,2600);
...
insert  into `userdetails`(`id`,`first_name`,`middle_name`,`last_name`,`email_id`,`mobile_num`,`address`,`pan_card_no`,`addhar_no`,`bank_name`,`ifsc_code`,`branch_name`,`account_no`,`user_password_id`,`balance`) values 
(1,'FirstName','MIddle Name','LastName','abc@gmail.com','9869849703','Test1Address','AKDPV2316F','0880-8089-9859-8878','Maharastra bank','7874587545','MUMBAI','457896554',1,800),
(2,'Nishant','S','Vibhute','nishantvibhute92@gmail.com','9856987456','GORAI Boraivali','AKDPV2316F','8898-8985-8985-9856','Mumbai','asdfdasf','Gorai','8978745544',3,600),
(3,'Nish','S','Vibhute','nishantvibhute23@gmail.com','9856987456','GORAI Boraivali','AKDPV2316F','8898-8985-8985-9856','Mumbai','asdfdasf','Gorai','8978745544',4,0),
(4,'N','S','Vibhute','nishantvibhute@gmail.com','9856987456','GORAI Boraivali','AKDPV2316F','8898-8985-8985-9856','Mumbai','asdfdasf','Gorai','8978745544',5,0);
...
(3,'nishantvibhute92@gmail.com','root','2018-01-18 11:21:31'),
(4,'nishantvibhute23@gmail.com','root','2018-01-18 11:22:35'),
(5,'nishantvibhute@gmail.com','root','2018-01-18 11:23:04');
...
insert  into `virtualuser`(`id`,`user_name`,`createdate`,`scheme_id`,`balance`,`createdFromId`) values 
(1,'Virtual_1','2018-01-19',1,0,0),
(2,'Virtual_2','2018-01-19',1,0,5);
...
/*!50003 CREATE PROCEDURE `createVirtualUser`(from_id int,scheme_id int)
BEGIN
...
/*!50003 CREATE PROCEDURE `deductPayment`(member_type_in int, user_id_in int, scheme_id_in int,amount_in float)
BEGIN
...
/*!50003 CREATE PROCEDURE `getSchemePoolDetails`(schemename varchar(50), limitrows int)
BEGIN
...
/* Procedure structure for procedure `getSchemePoolDetailsByName` */

/*!50003 DROP PROCEDURE IF EXISTS  `getSchemePoolDetailsByName` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `getSchemePoolDetailsByName`(schemename varchar(50))
BEGIN
SET @SQL4 = CONCAT("SELECT jd.member_type,IF(jd.`member_type`= 1, 
				(SELECT CONCAT(ud.`first_name`,' ',ud.`middle_name`,' ',ud.`last_name`)
					FROM  `userdetails` ud 
					WHERE id = jd.user_id),
				(SELECT user_name
					FROM  virtualuser 
					WHERE id = jd.user_id)) as 'parent name',jd.join_date,
	jd1.member_type,IF(jd1.`member_type`= 1, 
				(SELECT CONCAT(ud.`first_name`,' ',ud.`middle_name`,' ',ud.`last_name`)
					FROM  `userdetails` ud 
					WHERE id = jd1.user_id),
				(SELECT user_name
					FROM  virtualuser 
					WHERE id = jd1.user_id)) as 'child1 name',jd1.join_date,
	jd2.member_type,IF(jd2.`member_type`= 1, 
				(SELECT CONCAT(ud.`first_name`,' ',ud.`middle_name`,' ',ud.`last_name`)
					FROM  `userdetails` ud 
					WHERE id = jd2.user_id),
				(SELECT user_name
					FROM  virtualuser 
					WHERE id = jd2.user_id)) as 'child2 name',jd2.join_date,
	jd3.member_type,IF(jd3.`member_type`= 1, 
				(SELECT CONCAT(ud.`first_name`,' ',ud.`middle_name`,' ',ud.`last_name`)
					FROM  `userdetails` ud 
					WHERE id = jd3.user_id),
				(SELECT user_name
					FROM  virtualuser 
					WHERE id = jd3.user_id)) AS 'child3 name',jd3.join_date
FROM ",schemename," s JOIN `joining_details` jd
ON s.`parent_join_id` = jd.`id` LEFT JOIN `joining_details` jd1
ON s.child1_join_id = jd1.`id` LEFT JOIN `joining_details` jd2
ON s.child2_join_id = jd2.`id` LEFT JOIN `joining_details` jd3
ON s.child3_join_id = jd3.`id` ");
PREPARE stmt4 FROM @SQL4;
					EXECUTE stmt4;
	END */$$
DELIMITER ;

/* Procedure structure for procedure `getSchemePoolStats` */

/*!50003 DROP PROCEDURE IF EXISTS  `getSchemePoolStats` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `getSchemePoolStats`(scheme_id_in int)
BEGIN
	
	Declare physicalJoinMember int;

	Declare virtualJoinMember int;
	Declare rejectedMembers int;
	declare pendingVirtual int;
	Declare pendingPhysical int;
	Declare totalMembers int;
	
-- 	select count(id) into totalMembers
-- 	from `joining_details`
-- 	where  `scheme_id` = scheme_id_in; 



	select  'Physical Join' as "Label" , COUNT(id) as "Value"
	from `joining_details`
	where member_type = 1 and user_status = 2 and `scheme_id` = scheme_id_in
	UNION
	select  'Virtual Join' ,count(id) 
	from `joining_details`
	where member_type = 2 and user_status = 2 and `scheme_id` = scheme_id_in
	UNION
	select 'Rejected',count(id) 
	from `joining_details`
	where member_type = 1 and user_status = 3 and `scheme_id` = scheme_id_in
	UNION
	SELECT 'Physical Pending',COUNT(id) 
	FROM `joining_details`
	WHERE member_type = 1 AND user_status = 1 and `scheme_id` = scheme_id_in
	UNION
	SELECT 'Virtual Pending' , COUNT(id) 
	FROM `joining_details`
	WHERE member_type = 2 AND user_status = 1 and `scheme_id` = scheme_id_in;

select physicalJoinMember,virtualJoinMember,rejectedMembers,pendingVirtual,pendingPhysical;
...
BEGIN
	...
	select u.`id`,`first_name`,`middle_name`,`last_name`,u.`email_id`,`mobile_num`,`address`,`pan_card_no`,`addhar_no`,`bank_name`,`ifsc_code`,`branch_name`,`account_no`,`balance`,`password`
	from `userdetails` u join `userpassworddetails` up
	on up.`id` = u.`user_password_id`;
...
/*!50003 CREATE PROCEDURE `updatePaymentDetails`(`joining_id_in` int,`payment_type_in` int,`cheque_no_in` varchar(50),
...
DECLARE jc INT;
	...
	IF payment_type_in = 5 or payment_type_in = 4 then
		select  `user_id`,`member_type`,`scheme_id` into joinUserId,joinMemberType,schemejcId FROM `joining_details` where id = joining_id_in;
